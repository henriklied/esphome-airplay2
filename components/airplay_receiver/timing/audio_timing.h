...
// main/audio/audio_timing.h, PR #130 reduced engine-v2 revision).
//
...
// ones and ran a position servo.  Playback now lives in audio_scheduler.cpp,
...
//
// namespace esphome::airplay_receiver.  audio_format_t comes from
// ../audio/audio_receiver.h (pulled in below).
